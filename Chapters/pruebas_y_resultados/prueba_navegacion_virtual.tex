\subsection{Prueba 1: Navegación autónoma y mapeo con LiDAR simulado}
...
\bottomrule
\end{tabular}
\caption{Criterios de aprobación para la Prueba 1.}
...
\bottomrule
\end{tabular}
\caption{Resultados medidos para la Prueba 1 (a completar).}
